...
import { AuroraOverridePanel } from '@/components/playground/aurora-override-panel'
    ...
    <>
      ...
      <DirectionalTransition>
        <main className="kh-main kh-main--playground" id="inhoud">
          <div className="kh-pg-shell">
            <section className="kh-pg-intro">
              <p className="kh-eyebrow">Playground</p>
              <h1 className="kh-pg-title">
                De vloot, los van <span className="kh-accent">context</span>
              </h1>
              <p className="kh-pg-lead">Dezelfde zeven standen die elders vastliggen aan een pagina.</p>
            ...
            <section className="kh-pg-aurora">
              <p className="kh-eyebrow">Aurora-override</p>
              <p className="kh-pg-lead">
                Preset kies je via de swatches in de footer — dit legt sliders over de echte
                achtergrond. Puur exploratief.
              </p>
              <AuroraOverridePanel />
            </section>
          </div>
